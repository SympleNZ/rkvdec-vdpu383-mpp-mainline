...
- [`rkvdec-vdpu383-vp9`](https://github.com/SympleNZ/rkvdec-vdpu383-vp9) — the mainline V4L2 VP9 driver (bit-exact to MPP on KEY / single-reference / low-motion; compound is the open gap).
